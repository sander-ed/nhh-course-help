...
- [KarakterWeb](https://www.karakterweb.no/), where you can find grade distributions for each course for NHH + more schools
...
| ENE452  | $${\color{#5ae342}LOW}$$       | $${\color{#5ae342}LOW}$$       | $${\color{#5ae342}LOW}$$       | $${\color{#8c8c8c}invalid}$$ | $${\color{#e87910}HIGH}$$      | $${\textbf{No}}$$  | $${\textbf{5/10}}$$ |
